...
export function FeatureYouTube() {
  return (
        ...
        <AnimatedSection className="md:col-span-3 md:order-first">
          <div className="transform rotate-2 hover:rotate-0 transition-transform duration-500">
            <PhoneFrame
              ...
              alt="YouTube recipe search results"
            />
          </div>
        </AnimatedSection>
        <AnimatedSection className="md:col-span-2" delay={0.1}>
          <SectionLabel text="YouTube Discovery" />
          ...
          <p className="mt-6 text-lg text-stone-600 leading-relaxed max-w-prose">
            Search YouTube for cooking videos, browse channels, and save recipes
            directly from video transcripts. Follow your favorite creators.
          </p>
        </AnimatedSection>
      </div>
    </section>
